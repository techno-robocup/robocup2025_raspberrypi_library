...
def detect_green_marks(orig_image: np.ndarray,
  ...
  # Define green color range (optimized for teal-green in varying lighting)
  lower_green = np.array([35, 30, 10])
...
LINETRACE_CAMERA_SIZE = (3136, 2352)
