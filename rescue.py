...
def set_motor_speeds():
  ...
  L_Motor_Value = max(min(200,1500 + diff_angle + dist),1000)#TODO:Edit values
  R_Motor_Value = max(min(2000,1500 - diff_angle + dist),1000)
  logger.debug("Motor speed L:{L_Motor_Value}R:{R_Motor_Value}")
